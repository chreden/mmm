...
namespace mmm
{
    ...
    public:
        ...
        void add(const std::string& name, int table, int function);
    ...
    private:
        ...
        {
        public:
            explicit TestEntry(const std::string& name, int table, int function);
            void run(lua_State* L) const;
        private:
            bool call(lua_State* L) const;
