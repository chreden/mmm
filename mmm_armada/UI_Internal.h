...
namespace mmm
{
    ...
    {
    public:
        int addMessage(const std::string& text, int x, int y, eJustify justify, const ST3D_Colour& colour, bool fade, float displayTime);
        ...
        void update();
        void showTradesTo(const std::shared_ptr<Team>& player);
