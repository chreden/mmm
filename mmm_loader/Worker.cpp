...
*/
#include "../mmm_armada/Timer.h"
#include "../mmm_armada/UI_Internal.h"
#include "../mmm_armada/Media_Internal.h"
#include "../mmm_common/mmm_common.h"
#include "../mmm_armada/Application.h"
#include "../mmm_armada/DebuggerConnection.h"
#include "../mmm_armada/Cineractive_Internal.h"
#include "../mmm_armada/Game_Internal.h"
#include "../mmm_armada/LuaBinding.h"
#include "../mmm_armada/Globals.h"
#include "../mmm_armada/ScriptInterface.h"
#include "../mmm_armada/Debug_Internal.h"
#include "../mmm_armada/Type_Nebula.h"
#include "../mmm_armada/Functions.h"
#include "../mmm_armada/Monitor.h"
#include "../mmm_armada/TextInput.h"
#include "../mmm_armada/EntityReference.h"
...
namespace mmm
{
    ...
    namespace
    {
        ...
        void workerUpdate()
        {
            ...
            if(!storage.error && Game().getTime() - lastUpdate_ >= storage.updateTime)
            {
                EntityReference::updateReferences();
                timer_update(storage.mainLuaVM);
                UI().update( );
                textinput_update( );
                Monitor::update();
                Media::update();
