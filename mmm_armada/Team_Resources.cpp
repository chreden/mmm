...
namespace mmm
{
    ...
    float Team::Resources::getDilithium() const
    {
        return getResource(RESOURCE_DILITHIUM);
    }

    float Team::Resources::getMetal() const
    {
        return getResource(RESOURCE_METAL);
    }

    float Team::Resources::getLatinum() const
    {
        return getResource(RESOURCE_LATINUM);
    }

    float Team::Resources::getBiomatter() const
    {
        return getResource(RESOURCE_BIOMATTER);
    }

    float Team::Resources::getCrew() const
    {
        return getResource(RESOURCE_CREW);
    }

    float Team::Resources::getResource(eResource resource) const
    {
    ...
    void Team::Resources::setDilithium(float value)
    {
    ...
    void Team::Resources::setLatinum(float value)
    {
        typedef void (types::Team::*MemFunction)(float);
    ...
    void Team::Resources::setMetal(float value)
    {
        typedef void (types::Team::*MemFunction)(float);
    ...
    void Team::Resources::setBiomatter(float value)
    {
        typedef void (types::Team::*MemFunction)(float);
    ...
    void Team::Resources::setCrew(float value)
    {
        getScriptInterface()->SetTeamCrew(team_->m_teamNumber, value);
    }

    void Team::Resources::setTeam(types::Team* team)
    {
        team_ = team;
    }
}