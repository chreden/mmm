...
namespace mmm
{
    ...
    DebuggerConnection& DebuggerConnection::getInstance()
    {
        static DebuggerConnection connection;
        return connection;
    }

    bool DebuggerConnection::connected() const
    {
        return socket_ != 0;
    }

    bool DebuggerConnection::connect(const std::string& ip, int port)
    {
        disconnect();
    ...
    void DebuggerConnection::sendMessage(const std::string& message, DebuggerConnection::Type type)
    {
    ...
    bool DebuggerConnection::innerSend(const Message& message)
    {
    ...
    void DebuggerConnection::executeCommands()
    {
    ...
    void DebuggerConnection::update()
    {
